...
parser.add_argument('--train_annotations_dir', type=str, default='../Dataset/annotations/annotations_train_yolo_v5.txt', help='train annotations path')
parser.add_argument('--test_annotations_dir', type=str, default='../Dataset/annotations/annotations_test_yolo_v5.txt', help='test annotations path')
parser.add_argument('--class_name_dir', type=str, default='../Dataset/classes.names', help='classes name path')
...
parser.add_argument('--img_size', type=int, default=256, help='image target size')
